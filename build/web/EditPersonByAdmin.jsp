        ...
        <div class="container">
            <div class="book">
                <div class="description">
                    ...
                    <button class="subt" type="button"><a href="PersonByAdminServlet?a=${up.getEmail()}">Quay lại</a></button>
                </div>
                <div class="form">
                    <form action="EditPersonByAdmin" method="post" enctype="multipart/form-data">

                        <div class="inpbox">
                            <li>Email</li>
                            <span class="flaticon-globe"></span>
                            <input value="${up.getEmail()}" type="text" name="Email" readonly >
                        </div>
                        <div class="inpbox">
                            <li>Số Điện Thoại</li>
                            <span class="flaticon-globe"></span>
                            <input value="${up.getSoDienThoai()}" type="text" name="SoDienThoai">
                        </div>
                        <div class="inpbox">
                            <li>Tên</li>
                            <span class="flaticon-globe"></span>
                        ...
                        <div class="inpbox">
                            ...
                            <span class="flaticon-globe"></span>
                            <input value="${up.getNgayThangNamSinh()}" type="date" name="NgayThangNamSinh">
                        </div>                      
                        <div class="inpbox">
                            <li>Hình Ảnh</li>
                            <span class="flaticon-globe"></span>>
