...
//            UserAccount ua = (UserAccount) sess.getAttribute("acc");
            String MaBinhLuan = request.getParameter("pid");
            UserComment up = new UserComment();
            up = DBUtils.getCommentEdit(conn, MaBinhLuan);
            request.setAttribute("uc", up);
...
//        UserAccount ua = (UserAccount) sess.getAttribute("acc");
        try {
            ...
            UserComment up = DBUtils.getCommentEdit(conn, MaBinhLuan);
            String NoiDung=request.getParameter("NoiDung");
            DBUtils.updateComment(conn,MaBinhLuan,NoiDung);
            response.sendRedirect("ManagerCommentServlet");
        }  catch (SQLException ex) {
            Logger.getLogger(EditCommentServlet.class.getName()).log(Level.SEVERE, null, ex);
        } catch (ClassNotFoundException ex) {
            Logger.getLogger(EditCommentServlet.class.getName()).log(Level.SEVERE, null, ex);
