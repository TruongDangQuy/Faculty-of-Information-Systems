...
@WebServlet(name = "EditPersonByAdmin", urlPatterns = {"/EditPersonByAdmin"})
public class EditPersonByAdmin extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet EditPersonByAdmin</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet EditPersonByAdmin at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.getRequestDispatcher("EditPersonByAdmin.jsp").forward(request, response);
        } catch (SQLException ex) {
            Logger.getLogger(EditPersonByAdmin.class.getName()).log(Level.SEVERE, null, ex);
        ...
        try {
            ...
            if (conn != null) {
                try {
                    ...
                    Logger.getLogger(EditPersonByAdmin.class.getName()).log(Level.SEVERE,
                            null, ex);
                }
            }
